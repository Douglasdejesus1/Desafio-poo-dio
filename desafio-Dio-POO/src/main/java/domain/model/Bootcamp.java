...
public class Bootcamp {
	...
	private Set<Treinamento>treinamentos = new LinkedHashSet<>();
	...
	@Override
	public int hashCode() {
		return Objects.hash(dataFinal, dataInicial, descricao, devsInscritos, nome, treinamentos);
	}
	@Override
	public boolean equals(Object obj) {
		...
		return Objects.equals(dataFinal, other.dataFinal) && Objects.equals(dataInicial, other.dataInicial)
				...
				&& Objects.equals(nome, other.nome) && Objects.equals(treinamentos, other.treinamentos);
	}
